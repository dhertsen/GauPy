import log
import molecules
from gaussian.patterns import h, c, o, me, ch2, ipr
...
class SixFour(log.LOGFile):
    ...
    def _classify(self):
        ...
        if len(self.geometry.unparsed) == 1:
            self.geometry.furan_cation = molecules.Match(
    ...
    def _exoendo(self):
        ...
        if 0 <= angle <= (math.pi / 2):
            self.stereo = self.geometry.stereo = 'endo'
        else:
            self.stereo = self.geometry.stereo = 'exo'
